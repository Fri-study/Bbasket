      ...
      <div className=" w-[850px] h-96 bg-sky-300 m-1 p-2 rounded-md flex flex-wrap">
        <div id="addBookMarkTopDiv" className="w-[600px]">
          <input
            ...
            className="w-[520px] h-9 mANDp1 rounded-md"
            type="text"
          ...
          <button
            ...
            className="s_btn text-cyan-50 text-xs"
            type="button"
          >
            URL찾기
          </button>
        ...
        <div id="addBookMarkLeftDiv">
          <div className="place-content-start items-start flex w-[600px] h-36">
            <div
              id="theThumbnailDiv"
              className="w-48 h-28 bg-white m-1 mt-3 rounded-md inline-block"
            >
              <img
                id="theThumbnailImg"
            ...
            <div className="w-96 h-24 inline-block text-left">
              <input
                id="theTitle"
                className="roundOneInput mANDp1  inline"
                placeholder="원문제목"
              ...
              <input
                ...
                className="roundOneInput mANDp1 inline"
                placeholder="원문출처"
                defaultValue={okRespons ? data.get("scrapedAuthor") || "" : ""}
              />
              <textarea
                id="theTags"
                className="w-96 h-12 mANDp1 rounded-md"
                type="textarea"
                placeholder="#태그"
              />
            </div>
          ...
          <div className="block">
            <textarea
              type="textarea"
              id="newMemo"
              className="w-[585px] h-[130px] mANDp1 rounded-md block"
        ...
        <div
          ...
          className="w-[200px] h-[280px] rounded-md bg-slate-100"
        >
